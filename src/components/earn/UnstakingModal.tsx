      ...
      {!attempting && !hash && (
        <ContentWrapper gap="lg">
          ...
          <TYPE.subHeader style={{ textAlign: 'center' }}>
            When you withdraw, your AISis claimed and your liquidity is removed from the mining pool.
          </TYPE.subHeader>
      ...
      {attempting && !hash && (
        <LoadingView onDismiss={wrappedOndismiss}>
          <AutoColumn gap="12px" justify={'center'}>
            <TYPE.body fontSize={20}>Withdrawing {stakingInfo?.stakedAmount?.toSignificant(4)} BDSLP</TYPE.body>
            <TYPE.body fontSize={20}>Claiming {stakingInfo?.earnedAmount?.toSignificant(4)} AIS</TYPE.body>
          </AutoColumn>
        </LoadingView>
      )}
      {hash && (
        <SubmittedView onDismiss={wrappedOndismiss} hash={hash}>
          <AutoColumn gap="12px" justify={'center'}>
            ...
            <TYPE.body fontSize={20}>Withdrew BDSLP!</TYPE.body>
