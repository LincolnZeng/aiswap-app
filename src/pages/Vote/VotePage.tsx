...
import { TokenAmount, JSBI } from '@bdswap/sdk'
import { useActiveWeb3React } from '../../hooks'
import { PROPOSAL_LENGTH_IN_DAYS, COMMON_CONTRACT_NAMES, AIS, ZERO_ADDRESS } from '../../constants'
      ...
      <ProposalInfo gap="lg" justify="start">
        ...
        <AutoColumn gap="10px" style={{ width: '100%' }}>
          ...
          {proposalData && proposalData.status === 'active' && !showVotingButtons && (
            <GreyCard>
              <TYPE.black>
                Only AISvotes that were self delegated or delegated to another address before block{' '}
