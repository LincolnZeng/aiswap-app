      ...
      await bridgeMinerContract
        ...
        .then((response: TransactionResponse) => {
          addTransaction(response, {
            summary: `Withdraw deposited AIS`
          })
        ...
        <ContentWrapper gap="lg">
          ...
          {stakingInfo?.stakedAmount && (
            <AutoColumn justify="center" gap="md">
              ...
              <TYPE.body>Deposited AIS:</TYPE.body>
            </AutoColumn>
          )}
          {stakingInfo?.earnedAmount && (
            <AutoColumn justify="center" gap="md">
              ...
              <TYPE.body>Unclaimed HT</TYPE.body>
            </AutoColumn>
          )}
          <TYPE.subHeader style={{ textAlign: 'center' }}>
            When you withdraw, your HT is claimed and your AISis removed from the mining pool.
          </TYPE.subHeader>
      ...
      {attempting && !hash && (
        <LoadingView onDismiss={wrappedOndismiss}>
          <AutoColumn gap="12px" justify={'center'}>
            <TYPE.body fontSize={20}>Withdrawing {stakingInfo?.stakedAmount?.toSignificant(4)} AIS</TYPE.body>
      ...
      {hash && (
        <SubmittedView onDismiss={wrappedOndismiss} hash={hash}>
          <AutoColumn gap="12px" justify={'center'}>
            ...
            <TYPE.body fontSize={20}>Withdrew AIS!</TYPE.body>
