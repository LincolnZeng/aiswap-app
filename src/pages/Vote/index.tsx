...
import { AIS, ZERO_ADDRESS } from '../../constants'
import { JSBI, TokenAmount, ChainId } from '@bdswap/sdk'
...
export default function Vote() {
  ...
  const uniBalance: TokenAmount | undefined = useTokenBalance(account ?? undefined, chainId ? AIS[chainId] : undefined)
  ...
  return (
    <PageWrapper gap="lg" justify="center">
      ...
      <TopSection gap="md">
        <VoteCard>
          ...
          <CardSection>
            <AutoColumn gap="md">
              <RowBetween>
                <TYPE.white fontWeight={600}>BDSwap Governance</TYPE.white>
              </RowBetween>
              <RowBetween>
                <TYPE.white fontSize={14}>
                 AIStokens represent voting shares in BDSwap governance. You can vote on each proposal yourself or
              ...
              <ExternalLink
                ...
                target="_blank"
              >
                <TYPE.white fontSize={14}>Read more about BDSwap governance</TYPE.white>
              </ExternalLink>
            </AutoColumn>
          </CardSection>
          <CardBGImage />
      ...
      <TYPE.subHeader color="text3">
        A minimum threshhold of 1% of the total AISsupply is required to submit proposals
      </TYPE.subHeader>
    </PageWrapper>
  )
}
