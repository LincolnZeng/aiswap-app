    ...
    <PageWrapper gap="lg" justify="center">
      ...
      {showAddLiquidityButton && (
        <VoteCard>
          ...
          <CardSection>
            <AutoColumn gap="md">
              <RowBetween>
                <TYPE.white fontWeight={600}>Step 1. Get BankDefi Liquidity Pool token BDSLP</TYPE.white>
              </RowBetween>
              <RowBetween style={{ marginBottom: '1rem' }}>
                <TYPE.white fontSize={14}>
                  {`BDSLP tokens are required. Once you've added liquidity to the ${currencyA?.symbol}-${currencyB?.symbol} pool you can stake your liquidity tokens on this page.`}
                </TYPE.white>
              </RowBetween>
              <ButtonPrimary
                padding="8px"
      ...
      <PositionInfo gap="lg" justify="center" dim={showAddLiquidityButton}>
            ...
            <CardSection>
              ...
              <AutoColumn gap="md">
                ...
                <RowBetween style={{ alignItems: 'center', display:'flex',flexWrap:'wrap' }}>
                  ...
                  <TYPE.white>
                    BDSLP {currencyA?.symbol}-{currencyB?.symbol}
                  </TYPE.white>
                </RowBetween>
              </AutoColumn>
            </CardSection>
        ...
        {!showAddLiquidityButton && (
          <DataRow style={{ marginBottom: '1rem', gap:0 }}>
            <ButtonPrimary padding="8px" borderRadius="8px" width="160px" margin="6px" onClick={handleDepositClick}>
              {stakingInfo?.stakedAmount?.greaterThan(JSBI.BigInt(0)) ? 'Deposit' : 'Deposit BDSLP Tokens'}
            </ButtonPrimary>
        ...
        {!userLiquidityUnstaked ? null : userLiquidityUnstaked.equalTo('0') ? null : (
          <TYPE.main>{userLiquidityUnstaked.toSignificant(6)} BDSLP tokens available</TYPE.main>
        )}
      </PositionInfo>
    </PageWrapper>
  )
